...
### Локально
```bash
# python -m venv .venv (у нас вроде пока нет venv как такового...)
pip install -r requirements.txt
# python manage.py migrate (и бд тоже пока нет...)
...
<img width="1588" height="969" alt="sheme" src="https://github.com/user-attachments/assets/28de605d-11ad-447f-898d-cf7c092634ee" />
